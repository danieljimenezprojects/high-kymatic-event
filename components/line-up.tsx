...
export function LineUp() {
  ...
  const performers: Performer[] = [
    ...
    { 
      ...
      longDescription: "Known in the local scene, Scar is an upcoming DJ and producer making waves with his innovative approach to music. He infuses his sets with fresh energy and an unwavering love for music, creating an electrifying atmosphere for dancers and listeners alike.\n\nScar's philosophy is rooted in the belief that every dancer can transcend their limits when the music allows it. This perspective drives him to carefully craft his sets, always aiming to push the boundaries and inspire dancers to reach new heights in their performances.\n\nAs a rising star in the DJ world, Scar's unique style and dedication to his craft have quickly gained him recognition. His ability to read the crowd and adapt his music accordingly ensures that every set is a unique experience, tailored to elevate the energy of the event.\n\nWith his fresh take on music and his commitment to the dance community, Scar is poised to become a significant figure in the DJ scene. His presence at the High-kymatic event promises to bring an exciting new dimension to the musical landscape, and we can't wait to see how he elevates the vibe!"
    },
  ]
